 ...
 *
 */
public interface DataSearchService extends BaseDaoService {
	 ...
	 * @throws Exception
	 */
	AbstractQueryBuilder<?> matchAllQuery(BoolQueryType type) throws Exception;
	 ...
	 * @throws Exception
	 */
	AbstractQueryBuilder<?> simpleQueryStringQuery(String field, String value, SimpleQueryStringFlag flag,
	 ...
	 * @throws Exception
	 */
	AbstractQueryBuilder<?> termsQuery(String field, Collection<?> values, BoolQueryType type) throws Exception;

	AbstractQueryBuilder<?> termsQuery(String field, double[] value, BoolQueryType type) throws Exception;

	AbstractQueryBuilder<?> termsQuery(String field, float[] value, BoolQueryType type) throws Exception;

	AbstractQueryBuilder<?> termsQuery(String field, int[] value, BoolQueryType type) throws Exception;

	AbstractQueryBuilder<?> termsQuery(String field, Object[] value, BoolQueryType type) throws Exception;

	AbstractQueryBuilder<?> termsQuery(String field, long[] value, BoolQueryType type) throws Exception;

	AbstractQueryBuilder<?> termsQuery(String field, String[] value, BoolQueryType type) throws Exception;
